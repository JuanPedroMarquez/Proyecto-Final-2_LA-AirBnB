...
@st.cache_data
def load_data():
    return pd.read_csv(r'https://github.com/JuanPedroMarquez/Proyecto-Final-2_LA-AirBnB/blob/3842e4291dad0588f30a537385ed1e70d1d43602/LA_clean.csv', on_bad_lines='skip')
