...
@st.cache_data
def load_data():
    return pd.read_csv(r'https://github.com/JuanPedroMarquez/Proyecto-Final-2_LA-AirBnB/blob/1b4cc764a3183b17b733d0a67bca0795ea0f4418/LA_clean.csv', sep=",", engine="python", quoting=3, on_bad_lines="warn")
...
def show_interactive_map():
    ...
    listings = pd.read_csv(r'https://github.com/JuanPedroMarquez/Proyecto-Final-2_LA-AirBnB/blob/1b4cc764a3183b17b733d0a67bca0795ea0f4418/LA_clean.csv', usecols=columns_to_load)
